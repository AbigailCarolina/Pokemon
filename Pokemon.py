        ...
        for coordinate_x in range(MAP_WIDTH):
            ...
            if my_position[POS_X] == coordinate_x and my_position[POS_Y] == coordinate_y:
                ...
                if object_in_cell in map_trainers:
                    ...
                    if vida_gym_pokemon == 0:
                        print(f"======== Pikachu gana ======== {medals} {map_trainers}")
                        trainers -= 1
                        map_trainers.remove(trainer)
                        medals.remove(gym)

                        print(f"=== Has ganado la medalla {gym} ===\n"
                              f"------------------------------{trainers} {map_trainers}{gym}{medals}")
                    if vida_pikachu == 0:
            ...
            #todo al final pikachu nunca gana porque queda un pokemon en la lista 9,1 no sirve o nosé.
            print("{}".format(char_to_draw), end="")

        print("¦")

    print("+" + "-" * MAP_WIDTH * 3 + "+")
    print(f"{map_trainers}")
